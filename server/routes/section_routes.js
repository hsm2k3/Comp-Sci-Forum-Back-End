...
const section_routes = (app) => {
    ...
    app.get('/api/sections/id/:sectionId', SectionController.searchById); //Get one specific section by id
    ...
    app.put('/api/sections/id/:sectionId', SectionController.update); //Update a section
    app.delete('/api/sections/id/:sectionId', SectionController.destroy); //Delete a section
};
